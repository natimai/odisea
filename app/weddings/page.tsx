    ...
    <div className="min-h-screen">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center justify-center text-center">
          <div>
            ...
            <p className="text-xl text-gray-200">
              חוויה בלתי נשכחת ליום המיוחד שלכם
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold mb-6">אולם החתונות המושלם</h2>
            <p className="text-lg text-gray-600 mb-6">
              אודיסאה הוא המקום המושלם לחגוג את יום החתונה שלכם. האולם שלנו
              מציע חלל מרווח ואלגנטי, מערכת סאונד ותאורה מקצועית, ומטבח
              מאובזר להפליא.
            </p>
          ...
          <div className="relative h-[400px]">
            <Image
              src="/images/wedding-interior.jpg"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              אנחנו מציעים חבילות מותאמות אישית לכל זוג, כולל אפשרויות
